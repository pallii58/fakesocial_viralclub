...
export function GradientCard({
  ...
  return (
    <Link
      href={href}
      className="platform-card group overflow-hidden rounded-2xl border bg-gradient-to-br from-[#12121a]/90 to-[#0a0a10]/90 p-6 backdrop-blur-sm transition duration-300 hover:shadow-[0_0_40px_var(--card-glow)]"
      style={
        {
